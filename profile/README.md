...
* TD Bank joined the Fintech Open Source Foundation ([FINOS](https://www.finos.org)) as a Platinum Member with [Rajesh Raman](https://www.linkedin.com/in/rajesh-raman-a6a0681/) (Head of Credit Card and Unsecured Lending Technology) sitting on the FINOS Board — and [The Linux Foundation](https://www.linuxfoundation.org) as a Silver Member.
* In 2026, TD Bank has committed to the upgraded [Open Invention Network 2.0 Program](https://openinventionnetwork.com/open-invention-network-unveils-oin-2-0-to-enable-the-next-era-of-open-source-patent-protection/) - which is an expansion of the OIN Open Source Software mandate to include new technologies, particularly AI.
* TD Bank was a founding sponsor of the [Open Source in Finance Forum (OSFF) in Toronto](https://events.linuxfoundation.org/open-source-finance-forum-toronto/) and presented a keynote reminding the audience how important Toronto, Open Source, and Financial Institutions are to the foundation of AI and Deep Learning.
...
* [Backstage](https://github.com/backstage/backstage) is an open source framework for building developer portals - used by thousands of companies in all industries.  TD Bank, with many other companies, contributes to supporting this important project.
